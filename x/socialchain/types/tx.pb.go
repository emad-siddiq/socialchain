...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_5587f796e2f848ae, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5587f796e2f848ae, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "socialchain.socialchain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "socialchain.socialchain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("socialchain/socialchain/tx.proto", fileDescriptor_5587f796e2f848ae) }

var fileDescriptor_5587f796e2f848ae = []byte{
	// 344 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x28, 0xce, 0x4f, 0xce,
	0x4c, 0xcc, 0x49, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0x66, 0x97, 0x54, 0xe8, 0x15, 0x14, 0xe5,
	...
	0x55, 0x09, 0xb3, 0x52, 0x8a, 0xb5, 0x01, 0xe4, 0x35, 0xa7, 0x80, 0x13, 0x8f, 0xe4, 0x18, 0x2f,
	...
	0xd5, 0x4f, 0xcd, 0x4d, 0x4c, 0xd1, 0x2d, 0xce, 0x4c, 0x49, 0xc9, 0x2c, 0xd4, 0xc7, 0xed, 0xe1,
	0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0xdc, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff,
	0x2b, 0x63, 0xac, 0x43, 0x7b, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/socialchain.socialchain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/socialchain.socialchain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "socialchain.socialchain.Msg",
	...
	Metadata: "socialchain/socialchain/tx.proto",
}
